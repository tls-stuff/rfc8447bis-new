...
Instead of listing the changes and their rationale here in this, the
...
Alerts {{I-D.ietf-tls-tls13}}, TLS ContentType {{I-D.ietf-tls-tls13}},
...
Note:
 Extensions marked as "Y" are those allocated via Standards Track
 RFCs.  Extensions marked as "N" are not. The use of extensions 
 mared with "D" is discouraged.

Note:
: If an item is not marked as "N" it does not necessarily mean
...
"Y"; these groups apply to TLS 1.3 {{I-D.ietf-tls-tls13}} and
previous versions of TLS.  "Recommended" column is assigned a value of "N"
...
changed] the TLS Certificate Types regisry as follows:
